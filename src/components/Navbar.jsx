...
const Navbar = () => {
  ...
  return (
    <div className='text-white flex justify-between items-center h-24 max-w-7xl mx-auto px-4 pt-4'>
        <h1 className='w-full lg:text-5xl md:text-5xl font-semibold text-[#00df9a] font-poppins text-2xl'>Telwin</h1>
        ...
        <h1 className='w-full text-4xl font-semibold text-[#00df9a] m-4 mt-6 font-poppins'>Bruh</h1>
