...
const Trade = () => {
    ...
    function TextBuySell() {
        ...
        <div className='flex flex-col py-8 w-full gap-3 mx-auto'>
            ...
            <h3 className=' lg:text-7xl md:text-5xl text-6xl font-semibold gradient-text'>Trade.</h3>
            <h3 className=' lg:text-7xl md:text-5xl text-6xl font-semibold gradient-text'>Everywhere.</h3>
        </div>
        )
    }
