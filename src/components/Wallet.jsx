...
const Wallet = () => {
  ...
  const CryptoCard = ({ bgGradient, image, title, description, imgSize }) => {
    return (
      <div className={`lg:w-1/3 ${bgGradient} w-full flex justify-center text-center rounded-3xl transition-transform duration-300 hover:translate-y-3`}>
        <div className='flex items-center flex-col cursor-pointer'>
          ...
          <p className='text-center mx-10 text-white mt-4 mb-10 font-poppins font-medium'>{description}</p>
        </div>
      </div>
    );
  };
  ...
  return (
    <div className=' w-full bg-[#191919] py-16 px-4 h-[80vh]'>
      <div className='max-w-[1080px] mx-auto flex md:flex-row flex-col gap-11'>
